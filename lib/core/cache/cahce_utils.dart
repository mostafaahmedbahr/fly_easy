...
class CacheUtils {
  ...
  static bool isAcceptConditions(){
    return CacheHelper.getData(key: CacheKeys.acceptConditions)==null?false:true;
  }


  static Future<void>setNotificationsHint()async{
    await CacheHelper.putData(key: CacheKeys.isNotificationsHintShown, value: true);
  }
  ...
  static Future<void>setPersonalChatHint()async{
    await CacheHelper.putData(key: CacheKeys.isPersonalChatHintShown, value: true);
  }
  ...
  static Future<void>setCreateTeamHint()async{
    await CacheHelper.putData(key: CacheKeys.isCreateTeamHintShown, value: true);
  }

  static bool isNotificationsHintShown(){
    return CacheHelper.getData(key: CacheKeys.isNotificationsHintShown)==null?false:true;
  }
  static bool isSearchHintShown(){
    return CacheHelper.getData(key: CacheKeys.isSearchHintShown)==null?false:true;
  }
  static bool isEmailHintShown(){
    return CacheHelper.getData(key: CacheKeys.isEmailHintShown)==null?false:true;
  }
  static bool isPersonalChatHintShown(){
    return CacheHelper.getData(key: CacheKeys.isPersonalChatHintShown)==null?false:true;
  }
  static bool isHowToUseHintShown(){
    return CacheHelper.getData(key: CacheKeys.isHowToUseHintShown)==null?false:true;
  }
  static bool isCreateTeamHintShown(){
    return CacheHelper.getData(key: CacheKeys.isCreateTeamHintShown)==null?false:true;
  }
