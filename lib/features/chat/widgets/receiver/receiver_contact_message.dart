...
class ReceiverContactMessage extends StatelessWidget {
  const ReceiverContactMessage(
      {Key? key,
  ...
  Widget build(BuildContext context) {
    if (isGroup) {
      return Padding(
        padding: EdgeInsetsDirectional.only(start: isSameSender ? 45.w : 5.w, top: isSameSender ? 0 : 10.h),
        child: Row(
