...
import 'package:new_fly_easy_new/core/paymob_manager/paymob_constants.dart';
...
class PaymobManager{
  ...
  Future<String>_getAuthanticationToken()async{
    final Response response=await Dio().post(
        ...
        data: {
          "api_key":PayMobConstants.payMobApiKey,
        }
    );
  ...
  Future<String> _getPaymentKey({
    ...
    final Response response=await Dio().post(
        ...
        data: {
          ...
          "integration_id": PayMobConstants.paymentIntegrationId,//Integration Id Of The Payment Method
